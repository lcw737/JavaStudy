...
class Singer{
	...
	준다. Java에서 정의하는 모든클래스는 Object클래스를 상속하므로
	이와같이 오버라이딩 할 수 있다. */
	@Override
...
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		: Singer타입의 변수에 GirlGroup를 상속받은 익명클래스를
		생성해서 그 주소값을 할당한다.
		개념적으로 new GirlGroup(){};
			=>익명 extends GirlGroup 와 같다.
...
//		System.out.println(s3.mic);//에러발생됨. 자식에서 부모를 참조하는거라서 에러
		System.out.println(s3);
		
		/*
		인터페이스를 구현해서 익명클래스를 정의하낟. 오버라이딩이
